...
#          SIMULATION CONTROL           #
#.......................................#
time.stop_time               =   15005.0     # Max (simulated) time to evolve
time.max_step                =   -1         # Max number of time steps
time.fixed_dt         =   0.025        # Use this constant dt if > 0
time.cfl              =   0.95         # CFL factor
#time.start_time       = 15002
...
time.checkpoint_interval      =  40  #12000       # Steps between checkpoint files, every 300 s

ABL.bndry_file = "/projects/car/rthedin/amr_runs/02_precursor_shell/unstable.W.8at150.20dTinv_0.05q_0.75z0_850zi_3.84x1.28x0.9km_res2.5m/bndry_file.nc"
ABL.bndry_io_mode = 1
...
ABL.wf_velocity            = 0.577660 0.005875
ABL.wf_vmag                = 0.6347694758887161
ABL.wf_theta               = 302.0564233893689
BodyForce.magnitude        = 0.0003287218129234147 0.0007472518392366163 0.0
...
Actuator.TurbineFastLine.openfast_start_time = 1
...
#Actuator.T1.openfast_restart_file = "turbine_iea15mw/IEA-15-240-RWT-Monopile.400"
Actuator.T1.openfast_input_file   = "../../10_amrwind_issues/01_openfast_restart_turbine/t0_iea15mw/IEA-15-240-RWT-Monopile.fst"
Actuator.T1.openfast_restart_file = "../../10_amrwind_issues/01_openfast_restart_turbine/t0_iea15mw/IEA-15-240-RWT-Monopile.200"

# hub at 2381.25, 641.25, 0, considering overhang of 12.0313
Actuator.T2.base_position = 2393.28 641.25 0.
Actuator.T2.openfast_sim_mode = "restart"
#Actuator.T2.openfast_input_file = "turbine_iea15mw/IEA-15-240-RWT-Monopile.T2.fst"
#Actuator.T2.openfast_restart_file = "turbine_iea15mw/IEA-15-240-RWT-Monopile.T1.400"
Actuator.T2.openfast_input_file   = "../../10_amrwind_issues/01_openfast_restart_turbine/t1_iea15mw/IEA-15-240-RWT-Monopile.fst"
Actuator.T2.openfast_restart_file = "../../10_amrwind_issues/01_openfast_restart_turbine/t1_iea15mw/IEA-15-240-RWT-Monopile.T1.200"
