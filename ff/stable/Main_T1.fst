...
"../IEA-15-240-RWT-amr/IW_WT_Dummy.dat" InflowFile    - Name of file containing inflow wind input parameters (quoted string)
"../IEA-15-240-RWT-amr/IEA-15-240-RWT_AeroDyn.dat" AeroFile      - Name of file containing aerodynamic input parameters (quoted string)
"../IEA-15-240-RWT-amr/IEA-15-240-RWT-Monopile_ServoDyn.T1_mod.dat" ServoFile     - Name of file containing control and electrical-drive input parameters (quoted string)
"unused"      SeaStFile   - Name of file containing sea state input parameters (quoted string)
"unused"      HydroFile     - Name of file containing hydrodynamic input parameters (quoted string)
"../IEA-15-240-RWT-amr/IEA-15-240-RWT-Monopile_SubDyn.dat" SubFile       - Name of file containing sub-structural input parameters (quoted string)
