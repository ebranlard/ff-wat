...
---------------------- INPUT FILES ---------------------------------------------
"./IEA-15-240-RWT-Monopile_ElastoDyn.T1_mod.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
"./IEA-15-240-RWT-Monopile_ServoDyn.T1_mod.dat" ServoFile     - Name of file containing control and electrical-drive input parameters (quoted string)
