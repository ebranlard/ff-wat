...
---------------------- INPUT FILES ---------------------------------------------
"./IEA-15-240-RWT-Monopile_ElastoDyn.T2_mod.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
"/home/rthedin/repos/IEA-15-240-RWT/OpenFAST/IEA-15-240-RWT/IEA-15-240-RWT_BeamDyn.dat" BDBldFile(1)  - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"/home/rthedin/repos/IEA-15-240-RWT/OpenFAST/IEA-15-240-RWT/IEA-15-240-RWT_BeamDyn.dat" BDBldFile(2)  - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"/home/rthedin/repos/IEA-15-240-RWT/OpenFAST/IEA-15-240-RWT/IEA-15-240-RWT_BeamDyn.dat" BDBldFile(3)  - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"./InflowWind.dat" InflowFile    - Name of file containing inflow wind input parameters (quoted string)
"/projects/shellwind/rthedin/templateFiles/iea15MW/IEA-15-240-RWT-Monopile_AeroDyn15_4.0.dat" AeroFile      - Name of file containing aerodynamic input parameters (quoted string)
"./IEA-15-240-RWT-Monopile_ServoDyn.T2_mod.dat" ServoFile     - Name of file containing control and electrical-drive input parameters (quoted string)
"./IEA-15-240-RWT-Monopile_HydroDyn.dat" HydroFile     - Name of file containing hydrodynamic input parameters (quoted string)
"/projects/shellwind/rthedin/templateFiles/iea15MW/IEA-15-240-RWT-Monopile_SubDyn.dat" SubFile       - Name of file containing sub-structural input parameters (quoted string)
